...
- Parte C2 (ADR-0039): migration `20260926070000_contract_changes_v1` (NÃO aplicada em produção). Ficha do contrato como formulário (editar tabela, vendedor, valores e prazo, recalculando; pago = só dono/gerente com motivo), alterar repasse do vendedor por tipo (% ou R$, motivo, nunca acima do recebido), observações e histórico único, trava quando o vendedor já recebeu, tela Contratos com selo Alterado, filtro e ganho.
