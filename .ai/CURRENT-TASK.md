...
- Ficha completa do vendedor (ADR-0035, etapa 1): migration `20260926000100_seller_registration_v1` (NÃO aplicada em produção): código automático, dados básicos, contato, endereço residencial e comercial, contas PIX/TED com favorecido e histórico, contatos; `save_seller`. Tela: lista com "Novo vendedor" e ficha = formulário travado; Repasse mostra a conta principal ao pagar.
