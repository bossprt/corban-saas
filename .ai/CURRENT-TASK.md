...
- Exportação por banco ou geral e "Nova pesquisa" (ADR-0038): migration `20260926040000_import_row_origin_v1` (NÃO aplicada em produção). Importação lê a origem de cada linha (coluna Promotora parceira) e envia em blocos de 500.
