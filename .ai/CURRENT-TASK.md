...
- Migration `20260925150000_client_identity_edit_v1`: `update_client_identity` (nome, telefone e e-mail; o anterior fica no histórico) e `update_client_bank_account`. **Não aplicada em produção.**
