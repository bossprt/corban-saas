...
O endpoint não é signup público. O chamador precisa estar autenticado e possuir membership admin ativo. Nenhum organization_id vem confiado do cliente; o UUID da organização é criado pelo banco.
