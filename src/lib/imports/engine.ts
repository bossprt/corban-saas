...
import { importAdapters,bevicredAdapter,daycovalAdapter,efetivaMaisAdapter,commissionStatementAdapter,paymentStatementAdapter,networkPaymentStatementAdapter,productionStatusAdapter,twoTechBuscaContratoAdapter } from './adapters'
...
export function selectImportAdapter(input:{filename:string;mimeType?:string|null;headers?:string[];sourceKey?:string}):ImportAdapter|null{
 ...
 if(input.sourceKey==='2tech_busca_contrato')return twoTechBuscaContratoAdapter
