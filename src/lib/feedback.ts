...
export const FEEDBACK = {
  ...
  'ok:comissao_calculada': 'Comissão calculada.',
  'ok:contrato_atualizado': 'Contrato atualizado. A comissão foi recalculada.',
  'ok:repasse_alterado': 'Repasse do vendedor alterado.',
  'ok:repasse_regra': 'Repasse do vendedor voltou para a regra.',
  'ok:observacao_salva': 'Observação registrada.',
  'erro:contrato_recebido': 'O vendedor já recebeu a comissão deste contrato: nada mais pode mudar.',
  'erro:contrato_encerrado': 'Contrato recusado ou cancelado não pode ser alterado.',
  'erro:contrato_motivo': 'Informe o motivo da alteração (contrato já pago ao cliente).',
  'erro:repasse_invalido': 'Valor inválido: use % de 0 a 100 (ex.: 4) ou R$ (ex.: 800,00).',
  'erro:repasse_excede': 'O repasse não pode passar do que a empresa recebe neste tipo de comissão.',
  'erro:repasse_motivo': 'Informe o motivo da alteração do repasse.',
  'erro:repasse_sem_calculo': 'Calcule a comissão do contrato antes de alterar o repasse.',
  'erro:contrato_vendedor': 'Vendedor não encontrado ou inativo.',
  'erro:observacao_invalida': 'Escreva a observação (até 2.000 letras).',
  ...
  'ok:grupo_cadastrado': 'Grupo de vendedores cadastrado.',
  'ok:grupo_salvo': 'Grupo de vendedores salvo. A regra anterior fica guardada como versão antiga.',
  'ok:situacao_atualizada': 'Situação atualizada.',
  'ok:condicao_salva': 'Condição comercial salva com todos os grupos de vendedores.',
  ...
  'erro:comissao_excede': 'A regra do grupo paga mais do que a empresa recebe nesta linha. Revise o grupo ou a tabela.',
  'erro:comissao_sem_vendedor': 'O contrato não tem vendedor: informe o vendedor antes de calcular.',
  'erro:comissao_vendedor_sem_grupo': 'O vendedor não tem grupo: escolha o grupo no cadastro do vendedor.',
  'erro:comissao_grupo_sem_regra': 'O grupo do vendedor não tem regra de repasse: configure em Cadastros > Grupos de vendedores.',
  'erro:comissao_sem_base': 'A linha da tabela tem comissão em % sem base de cálculo (bruto ou líquido). Corrija a tabela.',
  'erro:comissao_ja_lancada': 'O repasse deste contrato já foi lançado: a comissão não é mais recalculada.',
  'ok:ir_retido_salvo': 'IR retido do banco salvo.',
  'erro:ir_retido_invalido': 'IR retido inválido: use um percentual de 0 a 100 (ex.: 0,5).',
  ...
  'erro:com_commission_group_not_found': 'Grupo de vendedores não encontrado ou inativo.',
  'erro:grupo_nome': 'Informe o nome do grupo (até 80 letras).',
  'erro:grupo_nome_repetido': 'Já existe um grupo com esse nome.',
  'erro:grupo_percentual': 'Confira os percentuais: número de 0 a 100, com até 6 casas decimais.',
  'erro:grupo_referencia': 'Essa coluna não pode ser usada: é do próprio grupo, de um grupo inativo ou de produção própria.',
  'erro:grupo_coluna_em_uso': 'Outro grupo lê a coluna deste. Troque a referência do outro grupo antes de marcar produção própria.',
  'erro:grupo_regra_incompleta': 'Preencha a coluna e o percentual de todos os tipos de comissão, e a base do supervisor e do gerente.',
  ...
  'erro:com_sem_grupos': 'Cadastre pelo menos um grupo de vendedores antes de registrar condições.',
  ...
  'erro:vendedor_email': 'Informe um e-mail válido.',
  'erro:vendedor_pix': 'Chave PIX inválida para o tipo escolhido (CPF/CNPJ, celular, e-mail ou chave aleatória).',
  'erro:vendedor_favorecido': 'CPF/CNPJ do favorecido inválido.',
  'erro:vendedor_conta': 'Confira a conta: TED precisa de tipo, banco, agência e conta; PIX precisa da chave; favorecido precisa de nome e CPF/CNPJ.',
  'erro:vendedor_contato': 'Confira os contatos: nome com pelo menos 2 letras, CPF, celular e e-mail válidos.',
