...
export const FEEDBACK = {
  ...
  'ok:vendedor_cadastrado_acesso_enviado': 'Vendedor cadastrado. O acesso foi criado e o convite foi enviado.',
  'ok:vendedor_cadastrado_acesso_pendente': 'Vendedor cadastrado e acesso preparado. O e-mail de convite não pôde ser enviado agora; o cadastro foi preservado.',
  'ok:vendedor_atualizado': 'Cadastro do vendedor atualizado.',
  'ok:vendedor_perfil_salvo': 'Dados cadastrais do vendedor salvos.',
  'ok:vendedor_endereco_salvo': 'Endereço do vendedor salvo e histórico preservado.',
  'ok:vendedor_pagamento_salvo': 'Dados de pagamento salvos. A versão anterior foi preservada.',
  'ok:vendedor_certificacao_salva': 'Certificação do vendedor salva.',
  'ok:vendedor_operacao_salva': 'Unidade e periodicidade de pagamento atualizadas.',
  'ok:vendedor_alias_salvo': 'Usuário de banco vinculado ao vendedor.',
  'ok:vendedor_alias_atualizado': 'Usuário de banco atualizado.',
  'ok:vendedor_acesso_criado': 'Acesso do vendedor criado. O login já pode ser usado.',
  ...
  'erro:vendedor_acesso_email': 'Para criar acesso ao sistema, informe um e-mail válido do vendedor.',
  'erro:vendedor_perfil': 'Não foi possível salvar os dados cadastrais do vendedor.',
  'erro:vendedor_endereco': 'Não foi possível salvar o endereço do vendedor.',
  'erro:vendedor_pagamento': 'Confira banco/Pix, titular e documento para pagamento da comissão.',
  'erro:vendedor_certificacao': 'Não foi possível salvar a certificação do vendedor.',
  'erro:vendedor_operacao': 'Confira Matriz/Filial e periodicidade de pagamento.',
  'erro:vendedor_alias': 'Confira a origem/banco e o usuário externo do vendedor.',
  'erro:vendedor_senha': 'A senha inicial deve ter pelo menos 12 caracteres, com maiúscula, minúscula, número e símbolo.',
  'erro:vendedor_acesso_existente': 'Este e-mail já possui usuário no sistema. Use recuperação de senha ou outro login.',
