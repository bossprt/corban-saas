...
import { BarChart3, Building2, CalendarCheck, KanbanSquare, LayoutDashboard, Settings, Users, WalletCards, type LucideIcon } from 'lucide-react'
import { cn } from '@/components/ui'

export type NavKey = 'hoje' | 'dashboard' | 'clientes' | 'esteira' | 'financeiro' | 'comercial' | 'relatorios' | 'configuracoes'
