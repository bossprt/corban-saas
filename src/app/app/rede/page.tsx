...
{canManage&&<div className="mt-8 grid gap-5 xl:grid-cols-2">
 ...
 <div className="mt-8 rounded-xl border border-slate-800 bg-slate-900 p-5"><h2 className="font-semibold">Regras comerciais publicadas</h2><p className="mt-2 text-sm text-slate-400">{rules.data?.length??0} versões de comissão · {splits.data?.filter(x=>x.status==='published').length??0} splits publicados</p></div>
