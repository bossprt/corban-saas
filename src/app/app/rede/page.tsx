...
import { createCommercialChannel, createCommercialEntity, createCommercialRelationship } from './actions'

export default async function NetworkPage() {
 const {supabase,membership}=await requireAppContext()
 const [entities,relationships,channels,splits,banks]=await Promise.all([
