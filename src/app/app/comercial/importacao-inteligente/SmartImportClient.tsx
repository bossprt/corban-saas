...
type Preview={
 ...
 economics:{table:string;contract:string;term:number;component:string;group:string;groupId:string;componentTypeId:string;mode:'share_of_received'|'direct'|'exclude';sharePct:string|null;receivedKind:'percentage'|'fixed_brl';gross:string;net:string;payout:string;retained:string|null;payoutKind:'percentage'|'fixed_brl'|null;compatible:boolean}[]
