...
export default async function ConfigurationPage() {
  ...
  return <section>
    ...
    <div className="mt-4 grid gap-3 sm:grid-cols-2">
      ...
      <Link href="/app/configuracao/repasse" className="rounded-xl border border-slate-800 bg-slate-900 p-4 text-sm hover:border-slate-600"><strong>Repasse</strong><span className="mt-1 block text-xs text-slate-400">Fechamento ou conta interna, frequência e limite de desconto do saldo negativo.</span></Link>
