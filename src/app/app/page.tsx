...
export default async function DashboardPage() {
  ...
  const [customers, proposals, jobs, cases, divergences, reviews, expected, received] = await Promise.all([
  ...
  const receivedTotal=(received.data??[]).reduce((s,x)=>s+Number(x.amount),0)
  return <section>
