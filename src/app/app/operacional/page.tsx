...
export default async function OperationalHubPage() {
  ...
  return <section>
    ...
    <h1 className="mt-1 text-3xl font-semibold">Backoffice e formalização</h1>
    <p className="mt-2 max-w-3xl text-sm text-slate-400">A área operacional organiza o trabalho que a equipe executa.</p>
