  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-900 px-4">
      <div className="w-full max-w-md rounded-xl border border-slate-700 bg-slate-800 p-8 shadow-2xl">
        <h1 className="text-2xl font-bold text-white">Definir senha inicial</h1>
        <p className="mt-2 text-sm text-slate-400">Acesso temporário e de uso único para o administrador da plataforma.</p>
