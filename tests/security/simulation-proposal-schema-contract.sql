...
and conname in ('simulations_customer_tenant_fk','simulations_table_version_tenant_fk','proposals_v2_customer_tenant_fk','proposals_v2_simulation_tenant_fk','proposals_v2_simulation_snapshot_fk','proposals_v2_table_version_tenant_fk')
order by conname;
...
from pg_trigger
where tgrelid='public.proposals_v2'::regclass
  and tgname='proposals_v2_commercial_snapshot_guard'
  and not tgisinternal;

select indexname,indexdef from pg_indexes
where schemaname='public' and indexname='simulations_org_id_customer_table_key';
