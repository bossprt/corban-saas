...
where n.nspname='public' and p.proname in ('generate_import_match_candidates','publish_financial_fact_from_import_decision','freeze_proposal_commercial_route','publish_expected_commission')
