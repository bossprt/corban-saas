...
test('money input is parsed to an exact decimal string without floating point', async () => {
  const { parseMoneyInput } = await import('../../src/lib/money-input')
  assert.equal(parseMoneyInput('9.500,00'), '9500.00')
  assert.equal(parseMoneyInput('R$ 1.234,5'), '1234.50')
  assert.equal(parseMoneyInput('9500'), '9500.00')
  assert.equal(parseMoneyInput('9500.75'), '9500.75')
  assert.equal(parseMoneyInput('0,10'), '0.10')
  assert.equal(parseMoneyInput(''), null)
  assert.equal(parseMoneyInput('-10'), 'invalid')
  assert.equal(parseMoneyInput('1,234.56'), 'invalid')
  assert.equal(parseMoneyInput('12,345'), 'invalid')
